...
var DOMAIN = "lzu.abaoli.cn/wordpress/wordpress";

var MINAPPTYPE="1";//小程序的类型，如果是企业小程序请填：0 ，如果是个人小程序请填：1
var WEBSITENAME="掌上兰大"; //网站名称

var MINAPPTYPE="1";//小程序的类型
var WEBSITENAME="兰州大学-校园展示作品"; //网站名称
...
var INDEXLISTTYPE="37,36" //首页显示所有分类
...
var INDEXNAV = [
    { id: '1', name: '校庆', image: '../../images/11.png', url: 'pages/shelf/shelf', redirecttype: 'miniapp', appid: 'wx55ea6098e41af5c4', extraData:'' },
    { id: '2', name: '最新', image: '../../images/12.png', url: '../hot/hot', redirecttype: 'apppage', appid: '', extraData:''},   
    { id: '3', name: '通知', image: '../../images/13.png', url: '../list/list?categoryID=98', redirecttype: 'apppage', appid: '', extraData: '' },
   ]
